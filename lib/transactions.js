...
var generateOutputTransactions = function (poolRecipient, recipients, rpcData) {
    ...
    //     var payeeScript = rpcData.founder.script
    ...
    // Smart node
    console.log("At Start ", rewardToPool)
    ...
    console.log("At 3 ", rewardToPool * (1 - (feePercent / 100)))
    console.log("At 3 ", rewardToPool )
...
exports.createGeneration = function(rpcData, blockReward, feeReward, recipients, poolAddress){
    ...
    console.log(Buffer.concat([p1,p2]).toString('hex'), "\n")
